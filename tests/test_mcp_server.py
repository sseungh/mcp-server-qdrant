...
class TestQdrantMCPServer:
    ...
    COLLECTION_NAME_STORE_SCHEMA = {
        "title": "Collection Name",
        "description": "Name of the collection to store the information in. Please list the existing collections to know which one to use, depending on the type of information.",
        "type": "string",
    }
